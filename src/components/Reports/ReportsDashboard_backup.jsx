...
const ReportsDashboard = ({ maintenanceData = [], expenseData = [], complaintData = [] }) => {
    ...
    <div className="reports-dashboard">
      ...
      <div className="kpi-grid">
        <div className="kpi-card">
          ...
          <div className="kpi-value">â‚¹{kpis.totalIncome.toLocaleString()}</div>
        ...
        <div className="kpi-card">
          ...
          <div className="kpi-value">â‚¹{kpis.totalExpenses.toLocaleString()}</div>
        ...
        <div className="kpi-card">
          ...
          <div className="kpi-value">â‚¹{kpis.pendingDues.toLocaleString()}</div>
